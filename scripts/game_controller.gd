...
var enemy_type_and_weights_dict:Dictionary[EnemyType, Callable] = ({
	...
	preload("uid://cr5n22p055thh"):func (x) -> float: return -0.0005 * (x-60) * (x-300), #1 - goblin type 2
	preload("uid://cbke16rl4k8ar"):func (x) -> float: return -0.0005 * (x-60) * (x-300), #2 - goblin type 3
	preload("uid://7mdhf8llrlod"):func (x) -> float: return -0.0005 * (x-60) * (x-300), #3 - goblin type 4
...
func spawn_enemies() -> void:
	...
	var enemy_quota:int = ceili((time_elapsed * 0.2) + 8)
