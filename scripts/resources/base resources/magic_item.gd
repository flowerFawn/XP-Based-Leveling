...
##affect_outgoing_damage(prior_damage:float -> float: - affects damage outgoing from a spell or projectile. specifically called when getting damage in a spell script
